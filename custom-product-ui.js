  ...
  function initBenefitsBlock() {
    ...
    wrapper.innerHTML = `
      <div class="link-group">
        <a href="https://wa.me/79771649500" target="_blank">Уточнить наличие у менеджера</a>
        <a href="#zeropopup1">Примерить в шоуруме</a>
      </div>
      <div class="delivery-info">
        <p>Каждое изделие создаётся вручную, поэтому возможны ограничения по наличию — уточните у менеджера. Все наши украшения очень важно примерить и почувствовать на себе, поэтому вы всегда можете оформить доставку с примеркой:</p>
        <ul>
